...
public class StatisticheCircoliPanel extends JPanel {
    ...
    public StatisticheCircoliPanel (final SecondaryFrame frame,
            final Dimension dim,
        ...
        this.search.addActionListener(e -> {
            this.model = new DefaultTableModel(queryManager.listCircoliToMatrix(
                    queryManager.findTopCircoli(
